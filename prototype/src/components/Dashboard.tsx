...
export default function Dashboard() {
  ...
  useEffect(() => {
    // If we somehow load the dashboard component but the state says "landing",
    // either we just arrived from login, or we have stale state.
    // If we have a session or username, let's auto-switch to "skills".
    if (view === "landing") {
      if (session || username) {
        setView("skills");
      } else {
  ...
  }, [view, session, username, router, setView]);

  useEffect(() => {
    // Auto-run analysis if we are on skills view, have no state, and have a username
    if (view === "skills" && !state && step === "idle" && (username || githubUsername)) {
      runAnalysis();
    }
  }, [view, state, step, username, githubUsername, runAnalysis]);
  ...
  return (
    <div style={{ display: "flex", height: "100vh", width: "100vw", overflow: "hidden", background: "var(--bg-primary)" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", background: "transparent", position: "relative", zIndex: 10 }}>
        ...
        {/* Top Header */}
        <header style={{ height: "64px", display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0 32px", background: "transparent", borderBottom: "none", zIndex: 10, flexShrink: 0 }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", flex: 1 }}>
            {/* Search removed as requested */}
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
            <button onClick={resetAll} style={{ background: "rgba(255,255,255,0.2)", backdropFilter: "blur(24px)", color: "#111827", border: "1px solid rgba(255,255,255,0.4)", padding: "8px 16px", borderRadius: "8px", fontWeight: 600, fontSize: "0.85rem", cursor: "pointer", transition: "all 0.2s" }} onMouseOver={e => e.currentTarget.style.background="rgba(255,255,255,0.4)"} onMouseOut={e => e.currentTarget.style.background="rgba(255,255,255,0.2)"}>
              New Analysis
            </button>
            ...
            {session ? (
              <div ref={dropdownRef} style={{ width: 32, height: 32, borderRadius: 8, background: "#8B5CF6", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "0.9rem", cursor: "pointer", position: "relative" }} onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
                ...
                {isDropdownOpen && (
                  <div style={{ position: "absolute", top: "100%", right: 0, marginTop: "8px", background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", borderRadius: "8px", boxShadow: "0 4px 12px rgba(0,0,0,0.1)", border: "1px solid #E5E7EB", overflow: "hidden", minWidth: "160px", zIndex: 100 }}>
      ...
      {view === "skills" && state && !isRunning && (
        <div className="fade-in" style={{ display: "flex", flexDirection: "column", gap: "24px", maxWidth: "1000px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: "24px", flexWrap: "wrap" }}>
            ...
            {/* User Profile Card */}
            <div style={{ flex: "1 1 400px", background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", borderRadius: "16px", border: "1px solid #E5E7EB", padding: "24px", display: "flex", alignItems: "center", gap: "24px", boxShadow: "0 1px 3px rgba(0,0,0,0.05)" }}>
            ...
            <div style={{ flex: "1 1 400px", background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", borderRadius: "16px", border: "1px solid #E5E7EB", padding: "24px", display: "flex", flexDirection: "column", justifyContent: "center", boxShadow: "0 1px 3px rgba(0,0,0,0.05)" }}>
          ...
          <div style={{ background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", borderRadius: "16px", border: "1px solid #E5E7EB", padding: "32px", boxShadow: "0 1px 3px rgba(0,0,0,0.05)" }}>
          ...
          <div style={{ background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", border: "1px solid #E5E7EB", borderRadius: "12px", padding: "20px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "16px", boxShadow: "0 1px 3px rgba(0,0,0,0.05)" }}>
             <div>
      ...
      {(view === "overview" || view === "gaps") && state && !isRunning && (
        <div className="fade-in" style={{ display: "flex", flexDirection: "column", gap: "32px", maxWidth: "100%", width: "100%", margin: "0 auto", paddingBottom: "48px" }}>
          ...
          {/* Header Action Bar */}
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", padding: "24px 32px", borderBottom: "1px solid #E5E7EB", borderRadius: "0 0 16px 16px" }}>
          ...
          <div style={{ display: "flex", gap: "24px", flexWrap: "wrap", alignItems: "flex-start", padding: "0 32px" }}>
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              {Object.entries(state.analysis_results.technical_proficiency)
                ...
                .slice(0, 4)
                .map(([name, data], idx) => (
                   <div key={`str-${idx}`} style={{ background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", borderRadius: "12px", border: "1px solid #10B981", padding: "20px", display: "flex", flexDirection: "column", gap: "12px", boxShadow: "0 1px 3px rgba(0,0,0,0.05)" }}>
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              {state.analysis_results.structural_gaps.map((gap, idx) => {
                 ...
                 if (isPriority) {
                   return (
                     <div key={`gap-${idx}`} style={{ background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", borderRadius: "12px", border: "1px solid #E5E7EB", display: "flex", flexDirection: "column", boxShadow: "0 1px 3px rgba(0,0,0,0.05)", overflow: "hidden" }}>
                 ...
                 return (
                   <div key={`gap-${idx}`} style={{ background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", borderRadius: "12px", border: "1px solid #E5E7EB", padding: "20px", display: "flex", flexDirection: "column", gap: "16px", boxShadow: "0 1px 3px rgba(0,0,0,0.05)" }}>
      ...
      {view === "roadmap" && state && !isRunning && (
        <div className="fade-in" style={{ width: "100%", maxWidth: "1200px" }}>
          {state.dynamic_roadmap.milestones.length > 0 ? (
            <div className="premium-container fade-in" style={{ marginBottom: 32, padding: "24px", background: "transparent" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", padding: "24px 32px", borderRadius: "16px", border: "1px solid var(--border)", boxShadow: "var(--shadow-sm)", marginBottom: "32px" }}>
                <div>
              ...
              {state.dynamic_roadmap.overall_learning_summary && (
                <div style={{ marginBottom: 32, padding: "20px", background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", borderRadius: "12px", borderLeft: "4px solid #3B82F6", borderTop: "1px solid var(--border)", borderRight: "1px solid var(--border)", borderBottom: "1px solid var(--border)" }}>
                  ...
                  return (
                    <div key={m.id} style={{ display: "flex", alignItems: "flex-start", gap: "40px", position: "relative", zIndex: 2, opacity: isUnlocked || isCompleted ? 1 : 0.5, transition: "opacity 0.3s" }}>
                      ...
                      <div style={{ marginLeft: "96px", flex: 1, display: "flex", flexDirection: "column" }}>
                        ...
                        {/* Main Card */}
                        <div style={{ background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", borderRadius: "20px", border: `1px solid ${isCompleted ? "#BBF7D0" : isStarted ? "#BFDBFE" : "#E5E7EB"}`, boxShadow: isStarted ? "0 4px 20px rgba(59,130,246,0.08)" : "0 4px 20px rgba(0,0,0,0.04)", overflow: "hidden", transition: "all 0.3s" }}>
                                      ...
                                      <div key={i} style={{ display: "flex", flexDirection: "column", gap: "12px", cursor: "pointer", transition: "transform 0.2s" }} onClick={() => window.open(targetUrl, "_blank")} onMouseOver={(e) => e.currentTarget.style.transform = "translateY(-4px)"} onMouseOut={(e) => e.currentTarget.style.transform = "translateY(0)"}>
                                        <div style={{ width: "100%", aspectRatio: "16/9", borderRadius: "12px", background: "#000", position: "relative", overflow: "hidden" }}>
                                          ...
                                          <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
                                            <div style={{ width: "36px", height: "36px", borderRadius: "50%", background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 12px rgba(0,0,0,0.15)" }}>
        ...
        <div className="fade-in" style={{ display: "flex", flexDirection: "column", gap: "24px", maxWidth: "1000px", margin: "0 auto", marginBottom: 48 }}>
          ...
          <div className="os-search-bar" style={{ marginBottom: "16px" }}>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              <div className="input-group" style={{ flex: 1 }}>
                <input className="input-field" style={{ background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", borderColor: "#E5E7EB", width: "100%", padding: "12px 16px", borderRadius: "8px", border: "1px solid #E5E7EB", outline: "none" }} placeholder={`Search for ${Object.keys(state.raw_github_metadata.languages)[0] || 'projects'}...`} />
              </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
            {osLoading ? (
              <>
                {[1, 2, 3].map(i => (
                  <div key={i} className="skeleton-pulse fade-in" style={{ background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", borderRadius: "16px", border: "1px solid #E5E7EB", padding: "24px", display: "flex", gap: "24px", alignItems: "stretch", opacity: 0.7 }}>
                    <div style={{ flex: "1 1 300px", display: "flex", flexDirection: "column", justifyContent: "center", gap: "12px" }}>
                      <div className="skeleton-pulse" style={{ height: "28px", width: "60%", borderRadius: "8px", background: "#E5E7EB" }} />
                      <div className="skeleton-pulse" style={{ height: "60px", width: "100%", borderRadius: "8px", background: "#E5E7EB" }} />
                      <div className="skeleton-pulse" style={{ height: "24px", width: "80%", borderRadius: "8px", background: "#E5E7EB" }} />
              ...
              osProjects.map((repo, idx) => {
                ...
                return (
                  <div key={repo.id} style={{ background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", borderRadius: "16px", border: "1px solid #E5E7EB", padding: "24px", display: "flex", gap: "24px", alignItems: "stretch", boxShadow: "0 1px 3px rgba(0,0,0,0.05)", flexDirection: "row", flexWrap: "wrap" }}>
      ...
      {isLoginModalOpen && (
        <div style={{ position: "fixed", top: 0, left: 0, width: "100vw", height: "100vh", background: "rgba(0,0,0,0.5)", zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", backdropFilter: "blur(2px)" }} onClick={() => setIsLoginModalOpen(false)}>
          <div style={{ background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", width: "90%", maxWidth: "440px", borderRadius: "16px", padding: "72px 40px 64px 40px", display: "flex", flexDirection: "column", alignItems: "center", boxShadow: "0 20px 40px rgba(0,0,0,0.2)" }} onClick={e => e.stopPropagation()}>
  ...
  return (
    <div style={{ width: "96px", height: "96px", position: "relative", marginBottom: "32px" }}>
      <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", background: "#10B981", borderRadius: "32px", transform: "rotate(-15deg)", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ width: "40px", height: "40px", background: "rgba(255, 255, 255, 0.2)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", borderRadius: "12px", transform: "rotate(15deg)", position: "relative" }}>
